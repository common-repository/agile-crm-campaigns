(function() {
    tinymce.PluginManager.add('agilecrm_campaigns_button', function( editor, url ) {
        editor.addButton( 'agilecrm_campaigns_button', {
            text: 'Agile Forms',
            icon: false,
            onclick: function() {
            jQuery.ajax({
                ...
                editor.windowManager.open( {
                    ...
                    onsubmit: function( e ) {
                        editor.insertContent( '[agileform_campaigns id="' + e.data.form+ '"]');
                    }
                });
                }
            });
